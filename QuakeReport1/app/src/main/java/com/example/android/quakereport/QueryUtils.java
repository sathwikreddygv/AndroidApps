    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
               ...
               for(int i=0; i<feature.length();i++){
                   ...
                   Date datetobeformatted = new Date(time);
                   SimpleDateFormat dateFormat1 = new SimpleDateFormat("MMMM dd,yyyy");
                   SimpleDateFormat dateFormat2 = new SimpleDateFormat("HH:mm:ss");
                   String date = dateFormat1.format(datetobeformatted);
                   String tym = dateFormat2.format(datetobeformatted);
                   earthquakes.add(new Earthquake(magnitude,place,date,tym));
               }
